...
const Details = ({ position, company, time, address, work, companyLink }: { position?: string, company?: string, time?: string, address?: string, work?: string, companyLink?: string }) => {
    ...
    return (
        <div className='my-64'>
            ...
            <div className='w-[75%] mx-auto relative'>
                ...
                <motion.div ref={ref} className='absolute left-9 top-0 w-[4px] h-full bg-dark origin-top dark:bg-light ' 
