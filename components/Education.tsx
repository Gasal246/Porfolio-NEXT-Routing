    ...
    return (
        <div className='my-64'>
            ...
            <div className='w-[75%] mx-auto relative'>
                ...
                <motion.div ref={ref} className='absolute left-9 top-0 w-[4px] h-full bg-dark dark:bg-light origin-top' 
                style={{scaleY:scrollYProgress}} />

                <ul className='w-full flex flex-col items-start justify-between ml-4'>
                    <Details type='BTech in Computer Science and Engineering'
